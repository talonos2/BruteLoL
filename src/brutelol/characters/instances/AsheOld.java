 ...
 * @author Talonos
 */
public class AsheOld extends AbstractLolCharacter
{    
   public AsheOld()
    {
    ...
    protected double getBasePhysicalDamagePerAttack(Build b, Build enemy) 
    {
        ...
        //Add crit modifiers.
        double damageIncludingCrits = damagePerAttack*1.1+(damagePerAttack*cappedCritChance*(1+stats.addedCritDamage));
