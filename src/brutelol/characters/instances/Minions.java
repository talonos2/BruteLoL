...
public class Minions extends AbstractLolCharacter
{
    ...
    public Minions() 
    {
        ...
        this.HP_PER_LEVEL = 100;
        this.HP_REGEN_PER_LEVEL = 0;
        this.MANA_PER_LEVEL = 0;
        this.MANA_REGEN_PER_LEVEL = 0;
        this.ATTACK_DAMAGE_PER_LEVEL = 0;
        this.ATTACK_SPEED_PER_LEVEL = 0;
        this.ARMOR_PER_LEVEL = 0;
